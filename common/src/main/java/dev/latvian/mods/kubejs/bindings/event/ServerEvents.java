...
public interface ServerEvents {
	...
	EventHandler COMMAND = GROUP.server("command", () -> CommandEventJS.class).supportsExtraId().cancelable();
	EventHandler CUSTOM_COMMAND = GROUP.server("customCommand", () -> CustomCommandEventJS.class).supportsExtraId().cancelable();
