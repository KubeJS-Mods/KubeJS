...
public class KubeJSForge {
	public KubeJSForge() throws Throwable {
		...
		FMLJavaModLoadingContext.get().getModEventBus().addListener(EventPriority.LOW, KubeJSForge::loadComplete);
		FMLJavaModLoadingContext.get().getModEventBus().addListener(EventPriority.LOW, KubeJSForge::initRegistries);
