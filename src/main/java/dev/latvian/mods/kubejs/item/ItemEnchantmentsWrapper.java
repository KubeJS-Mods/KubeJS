...
public class ItemEnchantmentsWrapper {
	public static final TypeInfo MAP_TYPE = TypeInfo.RAW_MAP.withParams(TypeInfo.of(Enchantment.class), TypeInfo.INT);
	...
	public static ItemEnchantments from(Context cx, Object from) {
		if (from instanceof ItemEnchantments e) {
			...
			var map = (Map<Enchantment, Integer>) cx.jsToJava(from, MAP_TYPE);
