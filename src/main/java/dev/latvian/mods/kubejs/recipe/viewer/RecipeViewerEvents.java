...
public interface RecipeViewerEvents {
	...
	SpecializedEventHandler<RecipeViewerEntryType> REMOVE_CUSTOM = GROUP.client("removeEntries", RecipeViewerEntryType.EXTRA, () -> RemoveEntriesKubeEvent.class).required();
	...
	SpecializedEventHandler<RecipeViewerEntryType> REGISTER_SUBTYPES = GROUP.client("registerSubtypes", RecipeViewerEntryType.EXTRA, () -> RegisterSubtypeKubeEvent.class).required();
